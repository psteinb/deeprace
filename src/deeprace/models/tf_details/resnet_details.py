...
def train(train, test, datafraction, opts):
    ...
    return None
    # from deeprace.models.tf_details import cifar10_main as cfmain
    # from deeprace.models.tf_details import resnet_run_loop as run_loop
...
#     from deeprace. import cifar10_main as cfmain
#     from deeprace. import resnet_run_loop as run_loop
